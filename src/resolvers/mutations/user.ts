import {IContext, ISignUpArgs, ISignUpPayloadResponse} from "../../interface/"
import Validator from "validator";
import bcrypt from "bcryptjs";
import jwt from "jsonwebtoken";
import { SERVER_KEY } from "../../key";

async function signUp(parent:any, args:ISignUpArgs, context:IContext):Promise<ISignUpPayloadResponse> {
